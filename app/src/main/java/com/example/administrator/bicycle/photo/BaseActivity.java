package com.example.administrator.bicycle.photo;
...
//	}
     ...
     */
    public void showPicturePopupWindow(int rid) {
        ...
        menuWindow.showAtLocation(findViewById(rid), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
    }
